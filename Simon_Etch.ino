const int speakerPin = 9;    // the pin that will be used for speaker output
const int tones[] = {1915, 1700, 1519, 1432, 2700}; // The last tone is the fail tone
const int ledpins[] = {0, 3, 4, 7}; //This was most convenient for soldering
const int buttonpins[] = {1, 2, 6, 8}; //This made soldering easy since I skipped every other pin
